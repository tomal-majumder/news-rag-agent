...
# call build_chromadb_from_articles with the correct parameters for semantic_chunking
def main():
    # Load sample data
    sample_type = 'tiny'
    ...
    splitter = 'semantic'  # Use semantic chunking
    collection_name = "news_articles_"
    build_chromadb_from_articles(sample_df, embeddings, embedding_function, batch_size=batch_size, splitter=splitter, collection_name=collection_name, sample_type=sample_type)